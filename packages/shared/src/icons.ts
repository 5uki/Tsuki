 ...
 *
 * 社交/品牌图标已迁移至 @iconify-json/fa6-brands、@iconify-json/fa6-solid，
 * 通过 astro-icon 的 <Icon> 组件按需渲染。
 */
...
export const navIcons = {
  ...
  posts:
    '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M10 13H8"/><path d="M16 17H8"/><path d="M16 13h-2"/></svg>',
  moments:
...
/**
 * 图标名称 → SVG 查找表（仅保留非 iconify 条目）
 *
 * iconify 格式图标（如 fa6-brands:github）通过 astro-icon <Icon> 组件直接渲染，
 * 无需在此注册。此表仅用于短名称别名。
 */
...
/**
 * 检测字符串是否为 iconify 图标名称（如 "fa6-brands:github"）
 */
